...
const testimonials = [
  {
    ...
    text: "El proceso para extranjeros suele ser complicado, pero el equipo lo hizo parecer fácil. Logré cerrar mi departamento en Brickell en tiempo récord."
  },
  {
    ...
    text: "Gracias a su asesoría pudimos calificar para un préstamo FHA con una tasa increíble. ¡Estamos felices en nuestra nueva casa en Doral!"
  },
  {
    name: "James Smith",
    role: "Propiedad de Lujo",
...
const Testimonials: React.FC<TestimonialsProps> = ({ onOpenForm }) => {
  ...
  return (
    <section id="testimonials" className="min-h-screen relative py-20 px-6 flex items-center overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-6 mb-8">
                    ...
                    <div className="text-center md:text-left">
                      <h4 className="text-xl font-bold text-navy-900">{testimonials[currentIndex].name}</h4>
                      <p className="text-gold-600 font-medium">{testimonials[currentIndex].role}</p>
                    </div>
                  </div>
        ...
        <div className="flex justify-center mt-12">
          <Button onClick={onOpenForm}>
            ÚNETE A NUESTRAS HISTORIAS DE ÉXITO
          </Button>
        </div>
      </div>
    </section>
